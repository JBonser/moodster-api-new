...
from app.moods.view import router as mood_router
from app.team_member_moods.view import router as member_mood_router
...
app.include_router(mood_router, prefix="/moods", tags=["moods"])
app.include_router(
    member_mood_router, prefix="/team_member_moods", tags=["team_member_moods"]
)
